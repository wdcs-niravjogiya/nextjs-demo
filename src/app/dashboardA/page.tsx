...
export default function Dashboard() {
  ...
  const getUserPost = () => {
    axios.get(`${postUrl}${user[0]?.id}`).then((res) => {
      ...
      {loading ? (
        ...
        <div className="w-screen max-w-[1440px] m-auto">
          <div className="flex flex-wrap gap-4 justify-center pt-32">
            ...
            <div
              onClick={getUserPost}
              className="flex flex-col gap-2 h-40 text-white rounded-xl shadow-md p-6 w-[240px] bg-gray-200 bg-opacity-30 backdrop-filter backdrop-blur-lg"
            >
